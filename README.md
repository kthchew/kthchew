...
- [ExtendFS](https://apps.kpchew.com/extendfs/) - A macOS FSKit module that adds support for mounting ext4, ext3 & ext2 drives, available [here on GitHub](https://github.com/kthchew/ExtendFS) and [on the Mac App Store](https://apps.apple.com/us/app/extendfs-for-linux-filesystems/id6755664332).
- [AMBerDisk](https://apps.kpchew.com/amberdisk/) - A macOS app to run actions or block disks on automount, [published on the Mac App Store](https://apps.apple.com/us/app/automount-blocker-amberdisk/id6745153167).
